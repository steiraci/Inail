...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Mail :  IEquatable<Mail>, IValidatableObject
    {
        /// <summary>
        ...
        public Mail(string codiceTipoMail = default(string), int? dataMovimentazione = default(int?), string descrizioneMail = default(string), string indirizzoMail = default(string))
        {
        ...
        {
            return this.Equals(input as Mail);
        }

        /// <summary>
        /// Returns true if Mail instances are equal
        /// </summary>
        /// <param name="input">Instance of Mail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Mail input)
        {
            if (input == null)
                return false;
